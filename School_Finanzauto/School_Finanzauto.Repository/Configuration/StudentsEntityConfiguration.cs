...
{
	public class StudentsEntityConfiguration : IEntityTypeConfiguration<Students>
	{
		public void Configure(EntityTypeBuilder<Students> builder)
		{
			...
			builder.HasMany(x=> x.Ratings).WithOne(x=> x.Student).HasForeignKey(x=>x.FkIdStudent);
